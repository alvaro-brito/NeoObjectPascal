// Generated from com/neoobjectpascal/NeoObjectPascalLexer.g4 by ANTLR 4.13.1
...
public class NeoObjectPascalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"USES", "BEGIN", "END", "VAR", "FUNCTION", "IF", "THEN", "ELSE", "WHILE", 
			"DO", "FOR", "TO", "WRITELN", "READLN", "SHOWMENU", "JSON_PARSE", "CSV_PARSE", 
			"INTO", "RETURN", "TYPE_INTEGER", "TYPE_STRING", "TYPE_BOOLEAN", "TYPE_REAL", 
			"TYPE_OBJECT", "ASSIGN", "COLON", "COMMA", "LPAREN", "RPAREN", "SEMI", 
			"DOT", "MUL", "DIV", "ADD", "SUB", "EQUAL", "NOT_EQUAL", "LT", "GT", 
			"LTE", "GTE", "PIPE", "INTEGER", "STRING", "IDENTIFIER", "WS", "COMMENT"
		};
	}
	...
	public NeoObjectPascalLexer(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "NeoObjectPascalLexer.g4"; }
